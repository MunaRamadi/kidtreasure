...
Route::middleware(['auth', 'verified'])->group(function () {
    ...
    Route::get('/profile/edit', [UserSettingsController::class, 'edit'])->name('profile.editUser');
    Route::post('/profile/edit', [UserSettingsController::class, 'update'])->name('profile.updateUser');
    ...
    Route::post('/profile/address/{address}/default', [UserSettingsController::class, 'setDefaultAddress'])->name('profile.address.default');
