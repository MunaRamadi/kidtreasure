...
<head>
    ...
    <title>Children's Treasures - Forgot Password</title>
                ...
                <div class="glass-card rounded-3xl p-8 md:p-12 max-w-md mx-auto lg:mx-0 pulse-advanced">
                    <div class="text-center mb-8">
                        <h1 class="text-4xl md:text-5xl font-black mb-4">
                            <span class="text-gradient-advanced">Password Recovery</span>
                        </h1>
            ...
            <div class="order-1 lg:order-2 fade-in-up">
                <div class="text-center lg:text-left">
                    <h2 class="text-5xl md:text-7xl font-black mb-8 leading-tight">
                        <span class="block text-white drop-shadow-2xl">Recover</span>
                        <span class="block text-gradient-advanced text-6xl md:text-8xl">Your Account</span>
                        <span class="block text-white text-3xl md:text-4xl font-bold mt-6 drop-shadow-lg">Easily and Securely</span>
                    </h2>
                    
                    <p class="text-xl md:text-2xl mb-12 leading-relaxed text-white/95 font-light">
                        Simple steps to recover your account and return to the world of learning and creativity with your children.
                    </p>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mt-12">
                        <div class="glass-card rounded-2xl p-6 text-center">
                            ...
                            <h3 class="text-lg font-bold text-white mb-2">Enter Your Email</h3>
                            <p class="text-white/80 text-sm">The email registered with your account</p>
                        </div>
                        ...
                        <div class="glass-card rounded-2xl p-6 text-center">
                            ...
                            <p class="text-white/80 text-sm">Follow the link sent to you</p>
                        </div>
                    </div>
                </div>
            </div>
