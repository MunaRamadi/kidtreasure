            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
                    ...
                    <div class="workshop-card glass-card card-hover-effect p-0 fade-in-up">
                        ...
                        <div class="p-6">
                            <div class="flex justify-between items-center mb-4">
                                <span
                                    class="bg-purple-500 bg-opacity-30 text-white px-3 py-1 rounded-full text-sm">Target Age Group: {{ $event->workshop->target_age_group ?? 'All Ages' }}</span>
                            ...
                            <p class="text-white text-opacity-80 mb-4">
                                {{ \Illuminate\Support\Str::limit($event->description ?? $event->workshop->description_en, 120) }}
                            </p>
                ...
                @empty
                    <div class="col-span-3 text-center py-12">
                        <h3 class="text-2xl font-bold mb-4">No upcoming events at the moment</h3>
                        <p class="text-white text-opacity-80">Please check back soon or register your interest below.</p>
                    </div>
                @endforelse
            </div>
            ...
            <div class="p-6 md:p-10">
                ...
                <form action="{{ route('workshops.register.interest') }}" method="POST" class="space-y-6">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div class="form-input-group">
                            <input type="email" name="parent_email" class="form-input" placeholder="Parent's Email *"
                                required>
                        </div>

                        <div class="form-input-group">
                            <input type="tel" name="parent_phone" class="form-input" placeholder="Parent's Phone *"
                                required>
                        </div>
                        ...
                        <div class="form-input-group">
                            <input type="number" name="child_age" class="form-input" placeholder="Child's Age *" min="3"
                                max="18" required>
                        </div>
                    ...
                    <div class="form-input-group">
                        <textarea name="special_requirements" class="form-input"
                    ...
                    <div class="form-input-group">
                        <div class="flex items-start">
                            <div class="flex items-center h-5">
                                <input type="checkbox" name="privacy_policy" id="privacy_policy" class="h-5 w-5 rounded"
                                    required>
                            </div>
                            <div class="ml-3 text-sm">
                                <label for="privacy_policy" class="text-gray-700">
                                    I agree to the <a href="#" class="text-blue-600 hover:text-blue-800 underline">Privacy
                                        Policy</a> and consent to be contacted about workshops.
                                </label>
                            </div>
                        </div>
                    </div>
            ...
            <div class="max-w-4xl mx-auto">
                <div class="space-y-6">
                    <div class="glass-card p-6 rounded-xl card-hover-effect bg-gradient-to-r from-blue-50 to-purple-50">
                        ...
                        <p class="text-gray-600">Our workshops are designed for children aged 5-12 years. We sometimes offer
                            specialized sessions for teenagers (13-17) as well.</p>
                    </div>

                    <div class="glass-card p-6 rounded-xl card-hover-effect bg-gradient-to-r from-blue-50 to-purple-50">
                        <h3 class="text-xl font-bold text-gray-800 mb-2">Do parents need to stay during the workshop?</h3>
                        <p class="text-gray-600">Parents are welcome but not required to stay. We have trained facilitators
                            who will guide and supervise all activities.</p>
                    </div>

                    <div class="glass-card p-6 rounded-xl card-hover-effect bg-gradient-to-r from-blue-50 to-purple-50">
                        <h3 class="text-xl font-bold text-gray-800 mb-2">What should my child bring to the workshop?</h3>
                        <p class="text-gray-600">All materials are provided! Just bring your child with comfortable clothes
                            that can get a little messy during creative activities.</p>
                    </div>

                    <div class="glass-card p-6 rounded-xl card-hover-effect bg-gradient-to-r from-blue-50 to-purple-50">
                        <h3 class="text-xl font-bold text-gray-800 mb-2">How long do the workshops last?</h3>
                        <p class="text-gray-600">Most of our workshops run for 2-3 hours, with short breaks included. The
                            exact duration is specified in each workshop description.</p>
                    </div>

                    <div class="glass-card p-6 rounded-xl card-hover-effect bg-gradient-to-r from-blue-50 to-purple-50">
                        <h3 class="text-xl font-bold text-gray-800 mb-2">What if my child has special needs?</h3>
                        <p class="text-gray-600">We strive to accommodate all children. Please let us know about any special
                            needs in advance so we can prepare accordingly.</p>
                    </div>
                </div>
