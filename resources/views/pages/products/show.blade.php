...
<section class="py-16 section-bg-pattern bg-gradient-to-br from-gray-50 via-blue-50 to-purple-50">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="fade-in-right">
                <div class="solid-card p-6">
                    <div class="product-image-container">
                        @php
                            // تحديد الصورة الرئيسية بناءً على البيانات المتاحة
                            $mainImage = null;
                    ...
                    @php
                        ...
                        if ($product->featured_image_path && \Illuminate\Support\Facades\Storage::disk('public')->exists($product->featured_image_path)) {
                            $thumbnails[] = [
                                ...
                                'active' => empty($thumbnails)
                            ];
                        }
                        
                        // إضافة الصورة العادية
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mt-16">
            @if($product->features)
            <div class="solid-card p-8 fade-in-up">
                <h3 class="text-2xl font-bold mb-4 text-gradient-advanced">المميزات الرئيسية</h3>
                <div class="text-section leading-loose">{!! nl2br(e($product->features)) !!}</div>
            </div>
            @endif

            @if($product->components)
            <div class="solid-card p-8 fade-in-up" style="animation-delay: 0.2s;">
                <h3 class="text-2xl font-bold mb-4 text-gradient-advanced">المكونات</h3>
                <div class="text-section leading-loose">{!! nl2br(e($product->components)) !!}</div>
            </div>
            @endif

            @if($product->skills_developed)
            <div class="solid-card p-8 fade-in-up" style="animation-delay: 0.4s;">
                <h3 class="text-2xl font-bold mb-4 text-gradient-advanced">المهارات المطورة</h3>
                <div class="text-section leading-loose">{!! nl2br(e($product->skills_developed)) !!}</div>
            </div>
            @endif

            @if($product->educational_benefits)
            <div class="solid-card p-8 fade-in-up" style="animation-delay: 0.6s;">
                <h3 class="text-2xl font-bold mb-4 text-gradient-advanced">الفوائد التعليمية</h3>
                <div class="text-section leading-loose">{!! nl2br(e($product->educational_benefits)) !!}</div>
            </div>
            @endif
        </div>
        
        @if($product->detailed_description)
        <div class="solid-card p-8 lg:p-12 mt-16 fade-in-up">
             <h2 class="text-4xl font-black text-center mb-8"><span class="text-gradient-advanced">تفاصيل المنتج</span></h2>
             <div class="prose max-w-none text-section leading-relaxed text-lg text-center mx-auto">
